...
- If error mentions missing chart dependencies or helm dependency build: decision retry_with_plan with action helm_deploy or repo_apply — the gitops agent will run helm dependency update automatically; do NOT tell the operator to run helm commands manually.
